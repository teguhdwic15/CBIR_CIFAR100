...
def search():
	...
	positif=['beaver', 'dolphin', 'otter', 'seal', 'whale',
	...
	for (score, resultID) in results:
		...
		saveimg = cv2.imwrite("static/temp/" + str(score) + str(i) + ".png", result)

	imgstr = time.strftime("%Y%m%d-%H%M%S")
	cv2.imwrite("static/tmp/"+ imgstr +".png", query)
	return redirect("/home")
